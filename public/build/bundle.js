...
/***/ function(module, exports, __webpack_require__) {
	...
	var Main = (function () {
	    ...
	    _createClass(Main, [{
	        ...
	        key: 'split',
	        value: function split(domElement) {
	
	            var splitedString = '';
	            domElement.innerText.split('').map(function (char, index) {
	        ...
	        value: function explode() {
	            ...
	            for (var i = 0; i < this.domTitle.innerText.length; i++) {
	
	                var rand = 75 - Math.random() * 150;
	
	                _gsap2['default'].to('.ps__heading .letter-' + i, 0.3, {
	                    css: {
	                        opacity: 0.3,
	                        letterSpacing: '0.7em',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _coreConfig = __webpack_require__(7);
	
	var _layersVideo = __webpack_require__(8);
	
	var _layersVideo2 = _interopRequireDefault(_layersVideo);
	
	var _layersTitle = __webpack_require__(10);
	...
	var PixelCanvas = (function () {
	    function PixelCanvas() {
	        ...
	        this.renderer = new PIXI.autoDetectRenderer(_coreConfig.CANVAS_WIDTH, _coreConfig.CANVAS_HEIGHT);
	    ...
	    _createClass(PixelCanvas, [{
	        ...
	        value: function setlayers() {
	            this.video = _layersVideo2['default'];
	            this.stage.addChild(this.video.sprite);
	
	            this.title = _layersTitle2['default'];
...
/***/ function(module, exports) {
	...
	exports.VIDEO_SPEED = VIDEO_SPEED;
	var VIDEO_LOOP = true;
...
/***/ function(module, exports, __webpack_require__) {
	        ...
	        value: function createShader() {
	            ...
	            this.uniforms = {
	                iResolution: {
	                    type: 'v3',
	                    value: {
	                        x: _coreConfig.CANVAS_WIDTH,
	                        y: _coreConfig.CANVAS_HEIGHT,
	                        z: 0
	                    }
	                },
	                iTime: {
	            ...
	            this.shader = new PIXI.AbstractFilter('', __webpack_require__(9), this.uniforms);
	...
	exports['default'] = new VideoLayer();
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TitleLayer = (function () {
	    function TitleLayer() {
	        _classCallCheck(this, TitleLayer);
	    ...
	    _createClass(TitleLayer, [{
	        ...
	        value: function createShader() {
	            ...
	            this.shader = new PIXI.AbstractFilter('', __webpack_require__(11), this.uniforms);
	...
	exports["default"] = new TitleLayer();
	module.exports = exports["default"];
